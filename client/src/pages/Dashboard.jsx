...
const STAT_CARDS = [
  ...
  { key: "idle", label: "Idle", color: "#6b7280", accent: "#374151" },
  {
    ...
    color: "#22c55e",
    accent: "#15803d",
    help: "Finished prints waiting for an operator to confirm good/bad before the next job dispatches",
  },
...
export default function Dashboard() {
  ...
  const utilPct = printers.length > 0 ? Math.round((stats.printing / printers.length) * 100) : 0;
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div
            style={{ width: 4, height: 36, background: "#1d4ed8", borderRadius: 2, flexShrink: 0 }}
          />
          <div>
            <div
              style={{ fontWeight: 800, fontSize: 20, letterSpacing: "0.05em", color: "#f1f5f9" }}
            >
              SYNTH YARD
            </div>
            <div
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: 12, color: "#475569", marginTop: 3 }}>{formatDate(clock)}</div>
          </div>
        ...
        <div style={{ background: "#111827", borderRadius: 10, padding: "16px 20px" }}>
          ...
          {active_projects.length === 0 ? (
            <p style={{ color: "#64748b", fontSize: 13, margin: 0 }}>
              No active projects. Create one on the Projects page and set it Active to track
              production here.
            </p>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      {proj.parts.map((part) => {
                        ...
                        const targetTickPct =
                          isOver && scale > 0 ? (part.target_qty / scale) * 100 : null;
                        const pct =
                          part.target_qty > 0
                              ...
                              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                ...
                                <span
                                  style={{
                                    fontSize: 12,
                                    fontWeight: 700,
                                    color: part.status === "closed" ? "#4ade80" : "#60a5fa",
                                    minWidth: 34,
                                    textAlign: "right",
                                  }}
                                >
                      ...
                      >
                        ...
                        {proj.elapsed_secs > 0 && (
                          <span style={{ color: "#94a3b8" }}>
                            {formatDuration(proj.elapsed_secs)}
                          </span>
                        )}
                        ...
                        {proj.material_used_grams > 0 && (
                          <span style={{ color: "#a78bfa" }}>
                            {formatMaterial(proj.material_used_grams)}
                          </span>
                        )}
