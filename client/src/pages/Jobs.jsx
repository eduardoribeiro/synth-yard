    ...
    <div>
      ...
      {jobs.length > 0 && (
        <div className="jobs-cards">
          {jobs.map((job) => {
            const st = JOB_STATUS[displayJobStatus(job)] || {
              bg: "#1f2937",
              text: "#9ca3af",
              label: job.status,
            };
            return (
              ...
              >
                ...
                <div style={{ color: "#94a3b8", fontSize: 12, marginBottom: 2 }}>
                  {job.project_name} · {job.printer_name}{" "}
      ...
      {jobs.length > 0 && (
        <div className="jobs-table-wrap" style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr
                style={{ color: "#64748b", textAlign: "left", borderBottom: "1px solid #2d3748" }}
              >
            ...
            <tbody>
              {jobs.map((job) => {
                ...
                return (
                  <tr key={job.id} style={{ borderBottom: "1px solid #1e2433", color: "#cbd5e1" }}>
                    <td
                      style={{
                        padding: "8px 10px",
                        color: "#475569",
